...
const MintedEthCappedCrowdsale = artifacts.require('MintedEthCappedCrowdsale.sol')
...
module.exports = deployer => {
  ...
  deployer.link(SafeMathLib, [CrowdsaleToken, MilestonePricing, MintedEthCappedCrowdsale, BonusFinalizeAgent])
  ...
  .then((instance) => {
    ...
    /* set MintedEthCappedCrowdsale as minting agent */
    return crowdsaleToken.setMintAgent(MintedEthCappedCrowdsale.address, true).then()
  })
  .then(() => {
  ...
  .then((instance) => {
    /* set BonusFinalizeAgent as finalize agent on MintedEthCappedCrowdsale */
  ...
  .then(() => {
    ...
    console.log(
      ...
      "-- MintedEthCappedCrowdsale: " + MintedEthCappedCrowdsale.address + "\n" +
      "\n"
    )
  })
}
